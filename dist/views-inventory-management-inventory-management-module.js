        ...
        this.dtOptions = {
            ...
            ajax: function (dataTablesParameters, callback) {
                ...
                if (!_this.firstTime) {
                    ...
                    jquery__WEBPACK_IMPORTED_MODULE_11__('.dataTables_filter input').val(_this.searchValue);
                    _this.firstTime = false;
                }
                _this.tableLimit = dataTablesParameters.limit;
                jquery__WEBPACK_IMPORTED_MODULE_11__('.dataTables_wrapper .dataTables_length label select').val(_this.tableLimit);
                // sorting
                dataTablesParameters.order[0].column == 0 ? dataTablesParameters.category = (dataTablesParameters.order[0].column == 0 && dataTablesParameters.order[0].dir == "asc") ? ("category") : ("-category") : "";
                dataTablesParameters.order[0].column == 1 ? dataTablesParameters.item_no = (dataTablesParameters.order[0].column == 1 && dataTablesParameters.order[0].dir == "asc") ? ("item_no") : ("-item_no") : "";
                dataTablesParameters.order[0].column == 3 ? dataTablesParameters.name = (dataTablesParameters.order[0].column == 3 && dataTablesParameters.order[0].dir == "asc") ? ("name") : ("-name") : "";
                dataTablesParameters.order[0].column == 4 ? dataTablesParameters.weight = (dataTablesParameters.order[0].column == 4 && dataTablesParameters.order[0].dir == "asc") ? ("weight") : ("-weight") : "";
                dataTablesParameters.order[0].column == 5 ? dataTablesParameters.available_quantity = (dataTablesParameters.order[0].column == 5 && dataTablesParameters.order[0].dir == "asc") ? ("available_quantity") : ("-available_quantity") : "";
                dataTablesParameters.order[0].column == 6 ? dataTablesParameters.sale_price = (dataTablesParameters.order[0].column == 6 && dataTablesParameters.order[0].dir == "asc") ? ("sale_price") : ("-sale_price") : "";
                dataTablesParameters.order[0].column == 7 ? dataTablesParameters.purchase_cost = (dataTablesParameters.order[0].column == 7 && dataTablesParameters.order[0].dir == "asc") ? ("purchase_cost") : ("-purchase_cost") : "";
                dataTablesParameters.order[0].column == 8 ? dataTablesParameters.margin = (dataTablesParameters.order[0].column == 8 && dataTablesParameters.order[0].dir == "asc") ? ("margin") : ("-margin") : "";
                dataTablesParameters.order[0].column == 9 ? dataTablesParameters.mark_up = (dataTablesParameters.order[0].column == 9 && dataTablesParameters.order[0].dir == "asc") ? ("mark_up") : ("-mark_up") : "";
            ...
            if (resData.status_code == 200) {
                ...
                if (type == 'pdf') {
                    if (onlyNameAndSymbolArr.length > 0) {
                        ...
                        jquery__WEBPACK_IMPORTED_MODULE_11__("#myDropdown").toggle();
                    }
                }
                else {

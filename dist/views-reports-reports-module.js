            ...
            if (resData.status_code == 200) {
                if (resData.data == 0) {
                    ...
                    var onlyNameAndSymbolArr = resData.data.map(function (x) { return ({
                        ...
                        "PO No": x.po_num || "-",
                        "Delivery Date": _this.datePipe.transform(x.created_at, "MM-dd-yyyy") || "-",
...
var AverageProductSalesComponent = /** @class */ (function () {
    function AverageProductSalesComponent(titleService, toastr, reportsService, commonService, router, datePipe) {
        this.titleService = titleService;
        this.toastr = toastr;
        this.reportsService = reportsService;
        this.commonService = commonService;
    ...
    AverageProductSalesComponent.prototype.goToProductOrderPage = function (selectedProduct) {
        this.router.navigate(["/reports/product-order"], {
            queryParams: { id: selectedProduct },
        });
    };

...
var SalesManagementService = /** @class */ (function () {
    ...
    SalesManagementService.prototype.getInvoicePdf = function (data) {
        ...
        // return this.http.post<any>(`${environment.base_url}/invoice_pdf/`, data, { responseType: 'blob' as 'json' });
    };
...
var OrderInvoiceComponent = /** @class */ (function () {
    ...
    OrderInvoiceComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (param) {
            ...
            _this.verified_product = param.verified == "true" ? 0 : 1;
    ...
    OrderInvoiceComponent.prototype.addFormControl = function () {
        this.addForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormGroup"]({
            ...
            payment_delivery_date: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormControl"]('', [
    ...
    OrderInvoiceComponent.prototype.addProductFormControl = function () {
        this.addProductForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormGroup"]({
            product_category: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormControl"]('', [
                _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required
            ]),
            vendor: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormControl"]('', [
                _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required
            ]),
            product_name: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormControl"]('', [
                _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required
            ]),
            ...
            final_amount: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormControl"]('', [
                _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required
            ])
        });
    };
    OrderInvoiceComponent.prototype.editProductFormControl = function () {
        this.editProductForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormGroup"]({
            ...
            product_name: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormControl"]({ value: '' }, [
                _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required
            ]),
            quantity: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormControl"]('', [
                _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required
    ...
    OrderInvoiceComponent.prototype.selectPackSize = function (type) {
        var _this = this;
        var quantity = (type == 1) ? (this.addProductForm.controls.quantity.value) : (this.editProductForm.controls.quantity.value);
        this.productDropdownData.forEach(function (element) {
            if (element.product_id == _this.selectedProduct) {
                _this.orderAmount = quantity != "" ? (element.sale_price * quantity) : element.sale_price;
        ...
        this.salesManagementService.getCustomer(this.customerId).subscribe(function (response) {
            ...
            if (resData.status_code == 200) {
                ...
                _this.addForm.patchValue({
                    billing_address: resData.data.billing_address + ", " + resData.data.billing_city + ", " + resData.data.billing_state + " " + resData.data.billing_zipcode,
                    shiping_address: resData.data.shipping_address + ", " + resData.data.shipping_city + ", " + resData.data.shipping_state + " " + resData.data.shipping_zipcode
                });
            }
            else {
                _this.toastr.error('', resData.message);
    ...
    OrderInvoiceComponent.prototype.getProductList = function () {
        ...
        return {
            ...
            ajax: function (dataTablesParameters, callback) {
                ...
                dataTablesParameters.order[0].column == 0 ? dataTablesParameters.sort_field = dataTablesParameters.order[0].column == 0 ? "order_product_name" : "" : "";
                dataTablesParameters.order[0].column == 1 ? dataTablesParameters.sort_field = dataTablesParameters.order[0].column == 1 ? "item_no" : "" : "";
                dataTablesParameters.order[0].column == 2 ? dataTablesParameters.sort_field = dataTablesParameters.order[0].column == 2 ? "category_name" : "" : "";
    ...
    OrderInvoiceComponent.prototype.getCreditList = function () {
        ...
        return {
            ...
            ajax: function (dataTablesParameters, callback) {
                ...
                _this.salesManagementService.creditMemoList({ customer_or_store_id: _this.customerId }).subscribe(function (response) {
                    var resData = JSON.parse(JSON.stringify(response));
                    if (resData.status_code == 200) {
    ...
    OrderInvoiceComponent.prototype.submitAddForm = function () {
        ...
        if (this.addForm.valid) {
            this.salesManagementService.edit_other_details(formData, this.orderId).subscribe(function (response) {
                var resData = JSON.parse(JSON.stringify(response));
                if (resData.status_code == 200) {
    ...
    OrderInvoiceComponent.prototype.submitAddProductForm = function () {
        ...
        formData.append("discount", this.addProductForm.controls.discount.value ? this.addProductForm.controls.discount.value : 0);
        ...
        if (this.addProductForm.valid && this.threeSoldLimit == "0" && this.minThreeSoldLimitError == "0") {
    ...
    OrderInvoiceComponent.prototype.submitEditProductForm = function () {
        ...
        formData.append("discount", this.editProductForm.controls.discount.value ? this.editProductForm.controls.discount.value : 0);
        ...
        if (this.editProductForm.controls.quantity.value != this.quantityEditValue || this.editProductForm.controls.order_amount.value != this.orderAmountEditValue || (this.editProductForm.controls.discount.value ? this.editProductForm.controls.discount.value : 0) != this.discountEditValue) {
            formData.append("update_calculations", "true");
        }
        else if (this.editProductForm.controls.product_name.value != this.productNameEditValue) {
            formData.append("update_calculations", "false");
        }
        else {
            formData.append("update_calculations", "false");
        }
        if (this.editProductForm.valid && this.threeSoldLimit == "0" && this.minThreeSoldLimitError == "0") {
            this.salesManagementService.edit_product(formData, this.orderId).subscribe(function (response) {
                var resData = JSON.parse(JSON.stringify(response));
                if (resData.status_code == 200) {
    ...
    OrderInvoiceComponent.prototype.submitAmountToApply = function () {
        ...
        this.creditMemoList.forEach(function (element) {
            if (element.amountToApply && element.checked) {
                data.push({ 'cm_id': element.id, 'credit_applied': parseFloat(element.amountToApply) });
            }
        });
        ...
        if (data.length == 0) {
            ...
            this.salesManagementService.applyCredit(formData)
    ...
    OrderInvoiceComponent.prototype.chnageValue = function (type) {
        this.finalAmount = type == 1 ? (this.orderAmount - (this.addProductForm.controls.discount.value * this.addProductForm.controls.quantity.value)) : (Math.round(this.editProductForm.controls.order_amount.value * this.editProductForm.controls.quantity.value * 100) / 100 - (this.editProductForm.controls.discount.value * this.editProductForm.controls.quantity.value));
    };
    OrderInvoiceComponent.prototype.changeOrderAmount = function (type) {
        this.chnageValue(type);
        this.threeSoldLimit = (this.finalAmount > this.maxThreeSoldLimit) ? "Order amount is higher than thresold limit." : "0";
        this.minThreeSoldLimitError = (this.finalAmount < this.minThreeSoldLimit) ? "Order amount is lower than thresold limit." : "0";
    };
    ...
    OrderInvoiceComponent.prototype.exportTable = function (type) {
        ...
        this.salesManagementService
            .getOrder(this.orderId, this.datatbaleData).subscribe(function (response) {
            var resData = JSON.parse(JSON.stringify(response));
            if (resData.status_code == 200) {
                var onlyNameAndSymbolArr = resData.data.products_list.map(function (x) { return ({
                    'Product Name': x.order_product_name ? x.order_product_name : x.product_name,
                    ...
                    'Order Amount': x.final_order_amount ? ("$ " + x.final_order_amount) : "$0",
                }); });
                if (type == 'pdf') {

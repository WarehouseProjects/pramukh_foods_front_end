...
var CustomerUserComponent = /** @class */ (function () {
    function CustomerUserComponent(titleService, toastr, costumerService, route, commonService, datePipe) {
        this.titleService = titleService;
        this.toastr = toastr;
        this.costumerService = costumerService;
        this.route = route;
        ...
        this.dtOptions = {
            ...
            ajax: function (dataTablesParameters, callback) {
                ...
                dataTablesParameters.order[0].column == 0
                    ? (dataTablesParameters.store_name =
                        dataTablesParameters.order[0].column == 0 &&
                ...
                dataTablesParameters.order[0].column == 1
                    ? (dataTablesParameters.full_name =
                        dataTablesParameters.order[0].column == 1 &&
                            dataTablesParameters.order[0].dir == "asc"
                            ? "full_name"
                            : "-full_name")
                ...
                dataTablesParameters.order[0].column == 4
                    ? (dataTablesParameters.min_threshold =
                        dataTablesParameters.order[0].column == 4 &&
                            dataTablesParameters.order[0].dir == "asc"
                            ? "min_threshold"
                            : "-min_threshold")
                ...
                dataTablesParameters.order[0].column == 5
                    ? (dataTablesParameters.open_balance =
                        dataTablesParameters.order[0].column == 5 &&
                            dataTablesParameters.order[0].dir == "asc"
                            ? "open_balance"
                            : "-open_balance")
                ...
                dataTablesParameters.order[0].column == 6
                    ? (dataTablesParameters.no_of_orders_places =
                        dataTablesParameters.order[0].column == 6 &&
                            dataTablesParameters.order[0].dir == "asc"
                            ? "no_of_orders_places"
                            : "-no_of_orders_places")
                ...
                dataTablesParameters.order[0].column == 7
                    ? (dataTablesParameters.total_order_amount =
                        dataTablesParameters.order[0].column == 7 &&
                            dataTablesParameters.order[0].dir == "asc"
                            ? "total_order_amount"
                            : "-total_order_amount")
                ...
                _this.costumerService.customerlist(dataTablesParameters).subscribe(function (respones) {
                    var resData = JSON.parse(JSON.stringify(respones));
                    if (resData.status_code == 200) {
    ...
    EditComponent.prototype.submitEditForm = function () {
        ...
        if (this.editForm.valid) {
            this.costumerService.customereditprofile(formData, this.customerId).subscribe(function (response) {
                var resData = JSON.parse(JSON.stringify(response));
                if (resData.status_code == 200) {
                    _this.router.navigate(['customer-user'], { queryParams: { firstTime: true, search: _this.searchValue } }).then(function () {
